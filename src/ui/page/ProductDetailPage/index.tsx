...
export default function ProductDetailPage({isLogin}: Props) {
  ...
  const fetchProductDetail = async () => {
    const response = setProduct(mockData);
    return response;
  }
      ...
      <div className="flex-row bg-white w-full h-auto" key={product.pid}>
        ...
        <div className="flex w-6xl mx-auto gap-3">
          ...
          <div className="right-container flex-4 bg-blue-50 flex-col p-3">
            ...
            <p className="text-xl mb-20">${product.price}</p>
            ...
            <div className="text-sm">
              ...
              {/*<p className="leading-relaxed">雙卡, 指紋解鎖, 面部解鎖, SD卡槽, NFC, 快速充電, 3.5mm插頭, 雙卡, 指紋解鎖,*/}
              {/*  面部解鎖, SD卡槽, NFC, 快速充電, 3.5mm插頭 雙卡, 指紋解鎖, 面部解鎖, SD卡槽, NFC, 快速充電,*/}
              {/*  3.5mm插頭</p>*/}
